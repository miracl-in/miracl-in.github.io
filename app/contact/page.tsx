      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">miraclin@fsociety.in</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 9543813232</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-6">Enroll Now or Get in Touch</h2>
            ...
            <div className="space-y-6">
              <div className="text-center p-6 md:p-8 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border-2 border-dashed border-blue-200">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">Enrollment & Contact Form</h3>
                <p className="text-sm md:text-base text-gray-600 mb-6">
                  Use this form to enroll in courses, request information, or get personalized career guidance. 
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                <p className="text-sm text-yellow-800">
                  <strong>For Course Enrollment:</strong> Please mention your preferred course, batch date, and mode (Online/Offline) in the form.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <span>Course enrollment assistance</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-green-500">✓</span>
